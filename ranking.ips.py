...
st.subheader("Ranking Geral por PIB per capita - Barras")

df_pib_ordenado = df.sort_values("PIB", ascending=False)
...
fig_ranking = px.bar(
    ...
    y="PIB",
    text="PIB",
    hover_data=["Rank", "Posição", "Pontuação", "Ano"],
    title="Municípios em ordem de PIB per capita - Maior para menor"
)
